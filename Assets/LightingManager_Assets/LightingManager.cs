...
public class LightingManager : MonoBehaviour
{
    ...
    #region Parameters
        ...
        public bool IsFogDensityChangeOn;
        [Tooltip("Fog density during day (x) and night (y). Higher values = thicker fog.")]
        public Vector2 FogDensity = new Vector2(0.001f, 0.05f);
        ...
        private void UpdateLighting(float timePercent)
        {
            ...
            if (SunDirectionalLight != null)
            {
                ...
                else if (timePercent >= morningInterval.x && timePercent <= morningInterval.y)
                {
                    ...
                    _fogDensity = Mathf.Lerp(FogDensity.y, FogDensity.x, morningNormalizedTime);
                }
                ...
                else if(timePercent >= afterNoonInterval.x && timePercent <= afterNoonInterval.y)
                {
                    ...
                    _fogDensity = Mathf.Lerp(FogDensity.x, FogDensity.y, afternoonNormalizedTime);
                }
